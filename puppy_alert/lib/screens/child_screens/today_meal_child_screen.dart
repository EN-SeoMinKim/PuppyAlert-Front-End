...
class TodayMealChildScreen extends StatefulWidget {
  const TodayMealChildScreen({super.key});

  @override
  State<TodayMealChildScreen> createState() => _TodayMealChildScreenState();
}

class _TodayMealChildScreenState extends State<TodayMealChildScreen> {
  @override
